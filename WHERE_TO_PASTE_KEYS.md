...
- Remove any old URLs with `com.travelstay.app` if they exist
...
- [ ] NO old `com.travelstay.app` URLs remain
- [ ] Click "Save" button
...
❌ **Don't use the old bundle ID** - Must be `com.ejar.app` not `com.travelstay.app`
