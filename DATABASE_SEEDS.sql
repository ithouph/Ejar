...
INSERT INTO public.posts (id, user_id, title, description, category, listing_type, property_type, location, price, image_url, images, amenities, specifications, created_at) VALUES
-- Property Posts
...
('850e8400-e29b-41d4-a716-446655440002', '650e8400-e29b-41d4-a716-446655440002', 'Beautiful Villa for Sale', 'Spacious 4 bedroom villa with garden and pool', 'property', 'buy', 'villa', 'Nouakchott', 2500000, 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=400&h=400&fit=crop', ARRAY['https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=400&h=400&fit=crop'], ARRAY['Pool', 'Garden', 'Garage'], '{"bedrooms": 4, "bathrooms": 3, "size": "450m2", "hasPool": true}'::jsonb, NOW()),
('850e8400-e29b-41d4-a716-446655440003', '650e8400-e29b-41d4-a716-446655440003', 'Land Plot for Investment', 'Prime location land in new development area', 'property', 'buy', 'land', 'Atar', 800000, 'https://images.unsplash.com/photo-1500595046891-0573cdc14d95?w=400&h=400&fit=crop', ARRAY['https://images.unsplash.com/photo-1500595046891-0573cdc14d95?w=400&h=400&fit=crop'], ARRAY[], '{"size": "1000m2", "zoned": "residential", "accessible": true}'::jsonb, NOW()),

-- Electronics
('850e8400-e29b-41d4-a716-446655440004', '650e8400-e29b-41d4-a716-446655440001', 'iPhone 14 Pro - Like New', 'Excellent condition, all accessories included', 'electronics', NULL, NULL, 'Nouakchott', 150000, 'https://images.unsplash.com/photo-1592286927505-1def25115558?w=400&h=400&fit=crop', ARRAY['https://images.unsplash.com/photo-1592286927505-1def25115558?w=400&h=400&fit=crop'], ARRAY[], '{"model": "iPhone 14 Pro", "storage": "256GB", "color": "silver", "condition": "like-new"}'::jsonb, NOW()),
('850e8400-e29b-41d4-a716-446655440005', '650e8400-e29b-41d4-a716-446655440002', 'MacBook Pro 16 inch', '2022 model, barely used, perfect for work', 'electronics', NULL, NULL, 'Nouakchott', 550000, 'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=400&h=400&fit=crop', ARRAY['https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=400&h=400&fit=crop'], ARRAY[], '{"model": "MacBook Pro 16", "year": 2022, "ram": "16GB", "storage": "512GB"}'::jsonb, NOW()),
('850e8400-e29b-41d4-a716-446655440006', '650e8400-e29b-41d4-a716-446655440003', 'Samsung 55 Smart TV', '4K Ultra HD, 2 years old, working perfectly', 'electronics', NULL, NULL, 'Nouakchott', 250000, 'https://images.unsplash.com/photo-1461896836934-ffe607ba8211?w=400&h=400&fit=crop', ARRAY['https://images.unsplash.com/photo-1461896836934-ffe607ba8211?w=400&h=400&fit=crop'], ARRAY[], '{"size": "55 inch", "resolution": "4K", "smartFeatures": true, "age": "2 years"}'::jsonb, NOW()),

-- Vehicles
('850e8400-e29b-41d4-a716-446655440007', '650e8400-e29b-41d4-a716-446655440001', 'Toyota Camry 2020', 'Well-maintained family car, low mileage', 'vehicles', NULL, NULL, 'Nouakchott', 850000, 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&h=400&fit=crop', ARRAY['https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&h=400&fit=crop'], ARRAY[], '{"make": "Toyota", "model": "Camry", "year": 2020, "mileage": "45000km"}'::jsonb, NOW()),
...
-- Furniture
('850e8400-e29b-41d4-a716-446655440009', '650e8400-e29b-41d4-a716-446655440002', 'Designer Sofa', 'Modern grey sofa, perfect for living room', 'furniture', NULL, NULL, 'Nouakchott', 200000, 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=400&h=400&fit=crop', ARRAY['https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=400&h=400&fit=crop'], ARRAY[], '{"type": "sofa", "color": "grey", "material": "leather", "seats": 3}'::jsonb, NOW()),
('850e8400-e29b-41d4-a716-446655440010', '650e8400-e29b-41d4-a716-446655440005', 'Dining Table Set', 'Wooden dining table with 6 chairs, barely used', 'furniture', NULL, NULL, 'Nouakchott', 350000, 'https://images.unsplash.com/photo-1517457373614-b7152f800fd1?w=400&h=400&fit=crop', ARRAY['https://images.unsplash.com/photo-1517457373614-b7152f800fd1?w=400&h=400&fit=crop'], ARRAY[], '{"type": "dining-set", "material": "wood", "seats": 6, "condition": "barely-used"}'::jsonb, NOW());
