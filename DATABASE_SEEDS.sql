...
INSERT INTO public.posts (id, user_id, title, description, category, listing_type, property_type, location, price, image_url, images, amenities, specifications, is_paid, is_approved, payment_approved, hit_limit, likes_count, rating, total_reviews, created_at, updated_at) VALUES
-- Property Posts
...
('850e8400-e29b-41d4-a716-446655440003', '650e8400-e29b-41d4-a716-446655440003', 'Land Plot for Investment', 'Prime location land in new development area', 'property', 'buy', 'land', 'Atar', 800000, 'https://images.unsplash.com/photo-1500595046891-0573cdc14d95?w=400&h=400&fit=crop', ARRAY['https://images.unsplash.com/photo-1500595046891-0573cdc14d95?w=400&h=400&fit=crop'], ARRAY[], '{"size": "1000m2", "zoned": "residential", "accessible": true}'::jsonb, true, true, true, false, 5, 0, 0, NOW() - INTERVAL '4 days', NOW() - INTERVAL '4 days'),

-- Electronics
('850e8400-e29b-41d4-a716-446655440004', '650e8400-e29b-41d4-a716-446655440001', 'iPhone 14 Pro - Like New', 'Excellent condition, all accessories included', 'electronics', NULL, NULL, 'Nouakchott', 150000, 'https://images.unsplash.com/photo-1592286927505-1def25115558?w=400&h=400&fit=crop', ARRAY['https://images.unsplash.com/photo-1592286927505-1def25115558?w=400&h=400&fit=crop'], ARRAY[], '{"model": "iPhone 14 Pro", "storage": "256GB", "color": "silver", "condition": "like-new"}'::jsonb, true, true, true, false, 8, 5, 1, NOW() - INTERVAL '3 days', NOW() - INTERVAL '3 days'),
('850e8400-e29b-41d4-a716-446655440005', '650e8400-e29b-41d4-a716-446655440002', 'MacBook Pro 16 inch', '2022 model, barely used, perfect for work', 'electronics', NULL, NULL, 'Nouakchott', 550000, 'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=400&h=400&fit=crop', ARRAY['https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=400&h=400&fit=crop'], ARRAY[], '{"model": "MacBook Pro 16", "year": 2022, "ram": "16GB", "storage": "512GB"}'::jsonb, false, false, false, true, 0, 0, 0, NOW() - INTERVAL '2 days', NOW() - INTERVAL '2 days'),
('850e8400-e29b-41d4-a716-446655440006', '650e8400-e29b-41d4-a716-446655440003', 'Samsung 55 Smart TV', '4K Ultra HD, 2 years old, working perfectly', 'electronics', NULL, NULL, 'Nouakchott', 250000, 'https://images.unsplash.com/photo-1461896836934-ffe607ba8211?w=400&h=400&fit=crop', ARRAY['https://images.unsplash.com/photo-1461896836934-ffe607ba8211?w=400&h=400&fit=crop'], ARRAY[], '{"size": "55 inch", "resolution": "4K", "smartFeatures": true, "age": "2 years"}'::jsonb, true, true, true, false, 3, 0, 0, NOW() - INTERVAL '1 day', NOW() - INTERVAL '1 day'),
...
-- Furniture
('850e8400-e29b-41d4-a716-446655440009', '650e8400-e29b-41d4-a716-446655440002', 'Designer Sofa', 'Modern grey sofa, perfect for living room', 'furniture', NULL, NULL, 'Nouakchott', 200000, 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=400&h=400&fit=crop', ARRAY['https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=400&h=400&fit=crop'], ARRAY[], '{"type": "sofa", "color": "grey", "material": "leather", "seats": 3}'::jsonb, false, false, false, false, 1, 0, 0, NOW() - INTERVAL '9 days', NOW() - INTERVAL '9 days'),
('850e8400-e29b-41d4-a716-446655440010', '650e8400-e29b-41d4-a716-446655440005', 'Dining Table Set', 'Wooden dining table with 6 chairs, barely used', 'furniture', NULL, NULL, 'Nouakchott', 350000, 'https://images.unsplash.com/photo-1517457373614-b7152f800fd1?w=400&h=400&fit=crop', ARRAY['https://images.unsplash.com/photo-1517457373614-b7152f800fd1?w=400&h=400&fit=crop'], ARRAY[], '{"type": "dining-set", "material": "wood", "seats": 6, "condition": "barely-used"}'::jsonb, true, true, true, false, 4, 0, 0, NOW() - INTERVAL '10 days', NOW() - INTERVAL '10 days');
