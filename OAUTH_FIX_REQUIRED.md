...
Your bundle identifier changed from `com.travelstay.app` to `com.ejar.app`, but Google Cloud Console and Supabase still have the old identifier. This **WILL cause OAuth redirect errors** until you update both platforms.
...
3. Find the iOS client with bundle ID `com.travelstay.app`
...
1. Find the Android client with package name `com.travelstay.app`
...
- 🔴 Change from: `com.travelstay.app://auth/callback`
...
**Cause**: Supabase still has `com.travelstay.app://auth/callback`  
...
**Cause**: OAuth consent screen still says "TravelStay"  
...
**What Changed:**
- Bundle identifier: `com.travelstay.app` → `com.ejar.app`
- Redirect URI: `com.travelstay.app://auth/callback` → `com.ejar.app://auth/callback`
