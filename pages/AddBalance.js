...
import {
  wallet as walletApi,
  balanceRequests as balanceRequestsApi,
...
export default function AddBalance({ navigation }) {
  ...
  const pickImage = async () => {
    ...
    if (status !== "granted") {
      Alert.alert(
        "Permission Required",
        "Please allow access to your photos to upload transaction proof.",
      );
      return;
    }
  ...
  return (
    <ThemedView style={styles.container}>
      ...
      >
        <View
          style={[styles.instructionsCard, { backgroundColor: theme.surface }]}
        >
        ...
        <View style={[styles.formCard, { backgroundColor: theme.surface }]}>
          ...
          <ThemedText
            type="bodyLarge"
            style={[styles.label, { marginTop: Spacing.lg }]}
          >
            Transaction Proof
          </ThemedText>
          ...
          <Pressable
            ...
            style={[
              styles.imagePicker,
              {
                backgroundColor: transactionImage
                  ? theme.background
                  : theme.border + "30",
            ...
            {transactionImage ? (
              <View style={styles.imagePreview}>
                ...
                >
                  ...
                  <ThemedText
                    type="caption"
                    style={{ color: theme.background, marginLeft: Spacing.xs }}
                  >
                    Change
                  </ThemedText>
                </View>
