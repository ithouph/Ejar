  ...
  return (
    <View style={[
      ...
      <ThemedText 
        ...
        style={[
          styles.messageTime,
          { color: isUser ? '#FFFFFF99' : theme.textSecondary }
        ]}
      >
        ...
        >
          ...
          <Pressable
            ...
            style={[styles.uploadButton, { 
              backgroundColor: selectedImage ? theme.success + '20' : theme.surface 
            }]}
          >
            <Feather 
            ...
            <ThemedText type="body">
              {selectedImage ? 'Payment proof attached' : 'Upload payment proof'}
            </ThemedText>
          </Pressable>
