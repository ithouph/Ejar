      ...
      >
        ...
        <View style={styles.section}>
          ...
          <ThemedText type="body" style={styles.paragraph}>
            By accessing and using Ejar, you accept and agree to be bound by the
        ...
        <View style={styles.section}>
          ...
          <ThemedText type="body" style={styles.paragraph}>
            Ejar provides a platform for booking hotels and apartments. You
        ...
        <View style={styles.section}>
          ...
          <ThemedText type="body" style={styles.paragraph}>
            ...
            terms and cancellation policies vary by property and will be clearly
        ...
        <View style={styles.section}>
          ...
          <ThemedText type="body" style={styles.paragraph}>
            Ejar acts as an intermediary between users and property owners. We
            are not responsible for the quality of accommodations or services
